...
CREATE TABLE `cours` (
  ...
  `statut` ENUM('BROUILLON', 'PUBLIE', 'ARCHIVE') NOT NULL DEFAULT 'BROUILLON', -- Exclus: EN_REVISION
...
CREATE TABLE `media` (
  ...
  `url_publique` VARCHAR(500) NULL,
  `url_externe` VARCHAR(500) NULL,
  `type` ENUM('VIDEO_MP4', 'VIDEO_WEBM', 'IMG_JPG', 'IMG_PNG', 'DOC_PDF') NULL,
